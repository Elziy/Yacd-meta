export const data = {
  ...
  'Direct Upload Total': 'Tổng tải lên trực tiếp',
  'Direct Download Total': 'Tổng tải xuống trực tiếp',
  'Proxy Upload Total': 'Tổng tải lên proxy',
  'Proxy Download Total': 'Tổng tải xuống proxy',
  ...
  delete_all_tags: 'Xóa tất cả thẻ',
  ...
  rule_provider: 'Nhà cung cấp quy tắc',
  ...
  remove_proxy_provider: 'Xóa nhà cung cấp proxy',
  add_rule: 'Thêm quy tắc',
  add_rule_set: 'Thêm bộ quy tắc',
  add_proxy_group: 'Thêm nhóm proxy',
  edit_proxy_group: 'Chỉnh sửa nhóm proxy',
